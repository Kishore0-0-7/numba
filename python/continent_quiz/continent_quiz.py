...
if guess_1 == "a" or guess_1 == "A": #prints correct and adds +1 to the score if correct
    print("Correct!")
    score += 1
else:
    print("Incorrect!")
...
if guess_2 == "a" or guess_2 == "A": #prints correct and adds +1 to the score if correct
    print("Correct!")
    score += 1
else:
    print("Incorrect!")
...
if guess_3 == "c" or guess_3 == "C": #prints correct and adds +1 to the score if correct
    print("Correct!")
    score += 1
else:
    print("Incorrect!")
...
if guess_4 == "c" or guess_4 == "C": #prints correct and adds +1 to the score if correct
    print("Correct!")
    score += 1
else:
    print("Incorrect!")
...
if guess_5 == "b" or guess_5 == "B": #prints correct and adds +1 to the score if correct
    print("Correct!")
    score += 1
else:
    print("Incorrect!")
